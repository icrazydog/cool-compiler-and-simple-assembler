...
public:
   ...
   virtual void addToSymTable(ClassP curClass) = 0;
   virtual Symbol valid(ClassP curClass) = 0;
...
protected:
   ...
   Symbol filename;
public:
   class__class* parentP;
   List<class__class> *childPList;
   bool notRecycle;
   bool isBaseClass;
   ...
   void triversalClass(List<class__class> *classList);
...
public:
   ...
   void dump(ostream& stream, int n);
   void addToSymTable(ClassP curClass);
   Symbol valid(ClassP curClass);
